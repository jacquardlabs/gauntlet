...
persists findings and chooses where. With prior findings in hand, note each finding as
new, persistent, or resolved. With none, this run is the baseline and `coverage` says
so. Never infer a trend from the repository alone.
